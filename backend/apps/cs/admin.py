...
class CancelRequestAdmin(admin.ModelAdmin):
    list_display   = ('order_number', 'customer_id', 'status', 'shipping_fee_burden', 'created_at')
    list_editable  = ('status',)
    search_fields  = ('order_number', 'customer_id')
    list_filter    = ('status', 'shipping_fee_burden')
    readonly_fields = ('order_number', 'customer_id', 'reason', 'created_at', 'updated_at')
    fields = ('order_number', 'customer_id', 'reason', 'status', 'shipping_fee_burden',
...
class RefundRequestAdmin(admin.ModelAdmin):
    list_display   = ('order_number', 'customer_id', 'requested_amount', 'approved_amount', 'status', 'created_at')
    list_editable  = ('status', 'approved_amount')
    search_fields  = ('order_number', 'customer_id')
    list_filter    = ('status',)
    readonly_fields = ('order_number', 'customer_id', 'reason', 'requested_amount', 'created_at', 'updated_at')
    fields = ('order_number', 'customer_id', 'reason', 'requested_amount', 'approved_amount',
